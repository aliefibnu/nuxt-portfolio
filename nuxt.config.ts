...
if (fs.existsSync(dataFilePath)) {
  try {
    ...
    console.log('Successfully auto-compiled my-data.md to app/data/portfolio-data.json')
  } catch (err) {
...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    appDescription: process.env.APP_DESCRIPTION || 'Fullstack Web & Backend Developer Portfolio',
