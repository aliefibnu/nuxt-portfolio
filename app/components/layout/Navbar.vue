...
<template>
  <header
    ...
    :class="[
      ...
      isScrolled
        ? 'py-4 bg-[#FAFAF9]/90 backdrop-blur-md border-b border-stone-200/80 shadow-sm'
  ...
  >
    ...
    >
      ...
      >
        <span
          class="w-2.5 h-2.5 rounded-full bg-blue-600 group-hover:scale-150 transition-transform duration-300"
        ></span>
      ...
      <nav class="hidden md:flex items-center gap-8 font-mono text-xs">
        <a
          href="#about"
          class="text-stone-500 hover:text-stone-900 transition-colors duration-300 interactive-hover"
          >ABOUT</a
        >
        <a
    ...
    >
      ...
      <!-- Links -->
      <nav
        class="flex flex-col gap-6 text-4xl font-headings font-bold text-stone-850 select-none"
      >
        <a
          href="#about"
          @click="toggleMobileMenu"
      ...
      <div class="flex flex-col gap-4">
        ...
        <div
          class="flex justify-between items-center text-xs font-mono text-stone-500"
        >
